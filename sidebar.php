...
if (get_queried_object()) {
  ...
  $parent_id = $postId = $categoryId = "";

  if (isset($post_obj->term_id)) {
    if($post_obj->parent != 0)
      $parent_id =  $post_obj->parent;
    else 
      $parent_id = $post_obj->term_id;
...
<div class="fixed-menus-wrap">
  ...
  <ul>
    ...
    foreach ($all_categories as $single_category) :
      ...
      $class = "";
      if($postId){
        $category = get_the_terms( $postId, 'hd-category' ); 
        //echo "<pre>";  
        //print_r($category);
