		...
		<div class="container">
			<div class="left-menu">
				<div class="main-logo">
					...
					if ($site_blue_logo) { 
						if( $ah_link ){
						    $link_url = $ah_link['url'];						    
						    $link_target = $ah_link['target'] ? $ah_link['target'] : '_self';
						?>
						<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><img class="svg" src="<?php echo esc_url($site_blue_logo['url']); ?>" alt="<?php echo esc_attr($site_blue_logo['alt']); ?>" width="95" height="42" /></a>
					<?php } 
					} ?>
					
				</div>
				<div class="menu-text">
					<a href="<?php echo esc_url(site_url('/')); ?>helpdesk">Helpdesk</a>
				</div>
			</div>
			<div class="right-menu">
				<?php $button_link = get_field('header_button', 'options'); 
				?>
				<a href="<?php echo $button_link['url']; ?>" target="<?php echo $button_link['target']; ?>">Go back home<span><img class="svg" src="<?php echo get_template_directory_uri(); ?>/images/right-arrow.svg" alt=""></span></a>
			</div><!-- right-bottom -->
		</div><!-- container -->
	</header><!-- #masthead -->
